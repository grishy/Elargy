...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','elex.py',59),
  ('statement -> expression','statement',1,'p_statement_expr','elex.py',64),
  ('expression -> expression + expression','expression',3,'p_expression_binop','elex.py',69),
  ('expression -> expression - expression','expression',3,'p_expression_binop','elex.py',70),
  ('expression -> expression * expression','expression',3,'p_expression_binop','elex.py',71),
  ('expression -> expression / expression','expression',3,'p_expression_binop','elex.py',72),
  ('expression -> - expression','expression',2,'p_expression_uminus','elex.py',84),
  ('expression -> ( expression )','expression',3,'p_expression_group','elex.py',89),
  ('expression -> NUMBER','expression',1,'p_expression_number','elex.py',94),
  ('expression -> NAME','expression',1,'p_expression_name','elex.py',99),
]
